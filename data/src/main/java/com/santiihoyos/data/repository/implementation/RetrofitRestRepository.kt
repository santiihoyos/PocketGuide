...
interface RetrofitRestRepository : RestRepository {
    ...
    override fun getCharactersPage(@Query("page") page: Int): CharactersResponse

    @GET("/character/{id}")
    @Headers(HEADER_ACCEPT_JSON, HEADER_CONTENT_TYPE_JSON)
    override fun getCharacterById(@Path("id") id: String): CharacterResponse
